...
import os
from systems import get_system_module, get_host, get_table_name , get_system_folder
...
def run_query(system, q_n, rangeL, rangeUnit, n_st, n_s, n_it=1, dataset="d1"):
    ...
    system_folder = get_system_folder(system)

    query_template = load_query(system_folder, q_n)
